...
exports.validatePost=[
    ...
    body("title").isAlpha().withMessage("Book's title must be string"),
    body("auther").isAlpha().withMessage("Book's auther must be string"),
    body("publisher").isAlpha().withMessage("Book's publisher must be string"),
